    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {weeks.map((week, index) => (
              <div key={index} className="relative animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                ...
                <Card className="p-6 hover:shadow-xl transition-all duration-300 relative z-10">
                  <div className="bg-accent rounded-full w-16 h-16 flex items-center justify-center mb-4 mx-auto">
                    <span className="text-2xl font-bold text-white">{week.number}</span>
                  </div>
                  <div className="bg-primary/5 rounded-full w-14 h-14 flex items-center justify-center mb-4 mx-auto">
                    <week.icon className="text-primary" size={28} />
                  </div>
        ...
        <div className="mt-12 text-center animate-scale-in">
          <Card className="inline-flex items-center gap-3 px-8 py-4 bg-accent-light border-accent">
            <Shield className="text-accent" size={32} />
            <div className="text-left">
              <p className="font-bold text-primary text-lg">Garantia de Resultado</p>
              <p className="text-sm text-muted-foreground">Identificamos no mínimo 5 vazamentos ou você ganha 1 Sprint extra</p>
            </div>
          </Card>
        </div>
      </div>
