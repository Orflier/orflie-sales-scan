    ...
    <section className="py-12 sm:py-20 bg-gradient-to-br from-accent to-accent-hover relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col gap-4 mb-8 max-w-2xl mx-auto px-4">
            <CTAButton 
              variant="primary" 
              size="lg"
              showArrow
              className="shadow-2xl text-sm sm:text-xl"
              action="form"
            >
            ...
            <CTAButton 
              variant="secondary" 
              size="default"
              className="shadow-lg opacity-80 text-xs sm:text-base"
              action="whatsapp"
